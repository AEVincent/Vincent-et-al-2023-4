...
data = read.delim("GMM_merged_RRF.csv",sep=",",stringsAsFactors=FALSE) #Single pixel data
...
write.table(data, file="GMM_95PIcorr_RRF.csv",row.names=FALSE,sep=",")
...
write.table(summ,file="GMM_95PICorr_SummaryOfDeficiencyCount.csv",row.names=FALSE,sep=",",quote=FALSE)
